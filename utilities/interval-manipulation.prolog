...
union_all0(Input, Result) :-
	getCPUTime(ST,yap),
	union_all(Input, Result),
	getCPUTime(ET,yap),
...
intersect_all0(Input, Result) :-
	getCPUTime(ST,yap),
	intersect_all(Input, Result),
	getCPUTime(ET,yap),
...
relative_complement_all0(Input, Diff, Result) :-
	getCPUTime(ST,yap),
	relative_complement_all(Input, Diff, Result),
	getCPUTime(ET,yap),
